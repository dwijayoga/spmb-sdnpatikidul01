...
# ==========================================
# 2. FUNGSI LOGIKA (WITH HIGH-EFFICIENCY CACHING)
# ==========================================

# Increased TTL to 10 minutes to handle 150+ users without API Quota errors
...
# Specifically cache the publication status to prevent excessive read requests


@st.cache_data(ttl=300)
def cek_status_pengumuman(_sheet_set):
    return _sheet_set.cell(1, 2).value
